...
class Investment(models.Model):
    customer = models.ForeignKey(Customer, related_name='investments', on_delete=models.CASCADE,)
...
class Stock(models.Model):
    customer = models.ForeignKey(Customer, related_name='stocks', on_delete=models.CASCADE,)
    ...
    def current_stock_price(self):
        ...
        api_key = '&interval=1min&apikey=Q13JBT2OLETDIBU1'
